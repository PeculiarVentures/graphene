...
function print_slot_algs_row(alg: any) {
    ...
    console.log(TEMPLATE,
        ...
        defs.print_bool(alg.flags & defs.MechanismFlag.DIGEST),
        defs.print_bool(alg.flags & defs.MechanismFlag.SIGN),
        defs.print_bool(alg.flags & defs.MechanismFlag.VERIFY),
        defs.print_bool(alg.flags & defs.MechanismFlag.ENCRYPT),
        defs.print_bool(alg.flags & defs.MechanismFlag.DECRYPT),
        defs.print_bool(alg.flags & defs.MechanismFlag.WRAP),
        defs.print_bool(alg.flags & defs.MechanismFlag.UNWRAP),
        defs.print_bool((alg.flags & defs.MechanismFlag.GENERATE) || (alg.flags & defs.MechanismFlag.GENERATE_KEY_PAIR)),
        defs.print_bool(alg.flags & defs.MechanismFlag.DERIVE)
    );
}
