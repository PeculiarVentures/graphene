...
declare namespace GraphenePkcs11 {
    ...
    class Collection<T extends BaseObject> extends BaseObject {
        ...
        constructor(items: Array<any>, lib: Pkcs11Js.PKCS11, classType: any);
    ...
    class SessionObjectCollection extends Collection<SessionObject> {
        ...
        constructor(items: Array<Handle>, session: Session, lib: Pkcs11Js.PKCS11, classType?: any);
    ...
    class Mechanism extends BaseObject {
        ...
        static create(alg: MechanismType): Pkcs11Js.Mechanism;
    ...
    class MechanismCollection extends Collection<Mechanism> {
        ...
        constructor(items: Array<number>, slotHandle: Handle, lib: Pkcs11Js.PKCS11, classType?: typeof Mechanism);
        /**
         * returns item from collection by index
         * @param {number} index of element in collection `[0..n]`
         */
    ...
    class Template {
        static toPkcs11(tmpl: ITemplate): Pkcs11Js.Attribute[];
        static fromPkcs11(tmpl: Pkcs11Js.Template): ITemplate;
    }
    ...
    class Slot extends HandleObject {
        ...
        flags: number;
        hardwareVersion: Pkcs11Js.Version;
        firmwareVersion: Pkcs11Js.Version;
        module: Module;
    ...
    class SlotCollection extends Collection<Slot> {
        ...
        constructor(items: Array<Buffer>, module: Module, lib: Pkcs11Js.PKCS11, classType?: any);
    }
    ...
    class Module extends BaseObject {
         ...
         */
        cryptokiVersion: Pkcs11Js.Version;
        /**
         ...
         * version of library
         */
        libraryVersion: Pkcs11Js.Version;
        constructor(lib: Pkcs11Js.PKCS11);
        protected getInfo(): void;
        /**
