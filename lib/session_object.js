...
SessionObject.prototype.getUtf8Attribute = function getUtf8yAttribute(attrType) {
    return _getUtf8Attribute(this, attrType);
}
...
function _getUtf8Attribute(obj, attrType) {
    var attrLen = obj.getAttribute(attrType);
    var res = "";
    if (attrLen) {
        res = obj.getAttribute(attrType, attrLen).toString("utf8");
    }
    return res;
}
...
SessionObject.prototype.getLabel = function getLabel() {
    return _getUtf8Attribute(this, CKI.CKA_LABEL);
}
