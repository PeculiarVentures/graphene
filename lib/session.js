...
Session.prototype.destroyObject = function DestroyObject(obj) {
	...
	if (!(obj instanceof SessionObject))
		throw new TypeError(Utils.printf(ERROR.TYPE, 1, "SessionObject"));
...
Session.prototype.generateKeyPair = function GenerateKey(algName, pukParams, prkParams) {
	var mech_type = getMechanismByName(algName);
	var mech = new CKI.CK_MECHANISM({
		mechanism: mech_type,
		pParameter: null,
