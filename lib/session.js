...
Session.prototype.generateRsa = function generateRsa(props) {
	return Rsa.generate(this, null, props);
}

Session.prototype.generateAes = function generateAes(props) {
	return Aes.generate(this, null, props);
}
